...
package com.github.shannah.jdeployuntitled1;
 ...
 * @author Shai Almog
 */
public class JdeployUntitled1Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Jdeploy Untitled1";
    private static final String APP_NAME = "jdeploy-untitled1";
    ...
    private JdeployUntitled1 mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new JdeployUntitled1Stub());
    }
